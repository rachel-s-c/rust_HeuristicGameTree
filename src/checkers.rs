...
impl<'a> CheckersGame {
	...
	pub fn print_board(&self) {
		...
		for i in 0..4 {
			println!("{}   {}   {}   {}   {}", i*2+1, print_piece(self.board[0 + i*8]),  print_piece(self.board[1 + i*8]), print_piece(self.board[2 + i*8]), print_piece(self.board[3 + i*8]),);
			println!("{} {}   {}   {}   {}   ", i*2+2, print_piece(self.board[4 + i*8]),  print_piece(self.board[5 + i*8]), print_piece(self.board[6 + i*8]), print_piece(self.board[7 + i*8]),);
		}
	}
